...
namespace TSS\Authentication\Controller\Plugin\Factory;
...
class IsAllowedPlugin implements FactoryInterface
{
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new \TSS\Authentication\Controller\Plugin\IsAllowedPlugin($acl, $role);
    }
