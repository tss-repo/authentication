...
use TSS\Auth\Filter\ProfileFilter;
use TSS\Auth\Form\UserForm;
...
class AccountController extends AbstractActionController
{
    public function indexAction()
    {
        ...
        $form->setAttribute('action', $this->url()->fromRoute('tssAuth/default', array('controller' => 'account')));
        $form->bind($user);
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect()->toRoute('tssAuth/default', array('controller' => 'account'));
            } else {
